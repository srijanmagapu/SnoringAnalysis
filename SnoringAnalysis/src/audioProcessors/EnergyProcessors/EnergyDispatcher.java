...
public class EnergyDispatcher
{
	...
	public void dispatchSound() throws UnsupportedAudioFileException, IOException{
		AudioDispatcher fdd = AudioDispatcherFactory.fromFile(source, bufferSize, bufferSize / 2);
		AudioDispatcher fdd2 = AudioDispatcherFactory.fromFile(source, bufferSize, bufferSize / 2);
		AudioDispatcher tdd = AudioDispatcherFactory.fromFile(source, bufferSize, 0);
