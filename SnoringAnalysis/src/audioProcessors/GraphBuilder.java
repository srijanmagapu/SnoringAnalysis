...
public class GraphBuilder
{
	...
	public void processAudioFile() throws IOException, UnsupportedAudioFileException
	{
		AudioDispatcher ad = AudioDispatcherFactory.fromFile(source, bufferSize, overlapping);
		format = ad.getFormat();
